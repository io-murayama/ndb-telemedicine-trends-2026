...
### 3.3a 年齢別の普及（Figure 4A / 4B）

![Figure 4A. 初診の年齢階級別変化（2022→2024）](../output/figures/figure4a_initial_change_by_age.png)

![Figure 4B. 再診・外来の年齢階級別変化（2022→2024）](../output/figures/figure4b_followup_change_by_age.png)
...
- **Figure 4A / 4B** は、年齢階級ごとの **絶対差** $p_{2024} - p_{2022}$（percentage points）を横棒で示し、「**誰に普及したか**」を比較する。
- 初診・再診・外来は **Figure を分離** して示す。
