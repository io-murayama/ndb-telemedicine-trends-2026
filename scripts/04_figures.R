...
fig4a <- plot_figure4_change_by_age(change, codes_cfg, visit_type = "initial")
fig4b <- plot_figure4_change_by_age(change, codes_cfg, visit_type = "followup")
...
save_figure(fig4a, "figure4a_initial_change_by_age.png", root = PROJECT_ROOT, width = 8, height = 9)
save_figure(fig4b, "figure4b_followup_change_by_age.png", root = PROJECT_ROOT, width = 8, height = 9)
